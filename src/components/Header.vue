...
function showChangelog() {
  Swal.fire({
    ...
    html: `<div style="text-align: left; font-size: 0.9em; line-height: 1.6;">
      <h4 style="color: #ff9800; margin-bottom: 5px;">🌟 อัปเดตล่าสุด (4.36.1) - 3 มิ.ย. 2026</h4>
        <ul>
          <li>🔔 <b>แจ้งเตือน Toast เมื่อยกเลิกสำเร็จ (Cancel Toast Notification)</b> — เมื่อระบบยกเลิกรายการสำเร็จ จะแสดง Toast แจ้งรหัสสินค้าที่ถูกยกเลิก พร้อมระบุ "(ล่าสุด)" หากเป็นการยกเลิกแบบอัตโนมัติ (ลูกค้าไม่ได้ระบุเลข) เพื่อให้แอดมินเห็นชัดเจนว่ารายการไหนถูกยกเลิก</li>
          <li>📋 <b>ปรับปรุง Logger สำหรับการยกเลิกอัตโนมัติ</b> — เพิ่ม log แจ้งรายละเอียดเมื่อระบบ auto-resolve หารายการล่าสุดของลูกค้า หรือเมื่อค้นหาไม่พบรายการ เพื่อช่วยวิเคราะห์ปัญหาได้ง่ายขึ้น</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.36.0) - 31 พ.ค. 2026</h4>
        <ul>
          <li>❌ <b>ระบบกระพริบตรวจสอบการยกเลิก (Cancel Blink Effect)</b> — เมื่อลูกค้าทำรายการยกเลิก (เช่น พิมพ์ยกเลิกผ่านแชท) ช่องสินค้าในตารางหลักจะกระพริบเป็นสีแดงพร้อมแสดงชื่อลูกค้าเดิมและสัญลักษณ์ ❌ เป็นเวลา 15 วินาทีก่อนจะเคลียร์เป็นช่องว่าง ช่วยให้แอดมินสังเกตเห็นและตรวจสอบข้อมูลการยกเลิกได้อย่างง่ายดาย โดยไม่กระทบกับระบบจัดการและคิวการจองเดิม</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.35.1) - 30 พ.ค. 2026</h4>
        <ul>
          <li>🔊 <b>แก้ไขแชทสดบางข้อความไม่ถูกอ่าน (Sequential Chat Processing)</b> — ปรับปรุงระบบประมวลผลข้อความแชทสดจาก YouTube ให้ประมวลผลทีละข้อความตามลำดับเวลาจริง (จากเดิมที่ส่งข้อความทั้ง batch พร้อมกัน) ทำให้ทุกข้อความถูกอ่านออกเสียงครบถ้วนไม่ตกหล่น และเรียงลำดับถูกต้อง</li>
          <li>🛡️ <b>แก้ไข Google TTS ไม่ Fallback เป็นเสียงในเครื่อง (TTS Fallback Fix)</b> — แก้บั๊กที่ทำให้เมื่อ Google Cloud TTS API ล้มเหลวทุก key (เช่น หมดโควต้า) ข้อความบางตัวจะไม่ถูกอ่านเลย เนื่องจากเงื่อนไขตรวจจับ key สุดท้ายผิดพลาด ตอนนี้ระบบจะ fallback ไปใช้เสียง TTS ในเครื่องคอมได้ถูกต้องทุกกรณี</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.35.0) - 28 พ.ค. 2026</h4>
        <ul>
          <li>🧹 <b>ระบบล้างประวัติการขายเก่าเกิน 3 เดือน</b> — เพิ่มปุ่มทำความสะอาดฐานข้อมูลรูปไม้กวาด (🧹) ในหน้าต่างประวัติการขาย สามารถตรวจสอบจำนวนไลฟ์ทั้งหมด จำนวนไลฟ์ที่จะถูกลบ และคำนวณประเมินขนาดพื้นที่ที่ฐานข้อมูลจะได้รับคืนก่อนทำการลบถาวรได้อย่างแม่นยำ</li>
          <li>🛡️ <b>ปรับปรุงระบบลบประวัติป้องกันข้อมูลขยะตกค้าง (Clean Delete)</b> — ปรับปรุงคำสั่งลบประวัติให้ลบข้อมูลทุกโหนดใน Firebase อย่างหมดจด ได้แก่ ข้อมูลการจองสต็อก (stock), แชทสด (chats), เมทาดาตาประวัติ (history), ตั้งค่าสต็อก (settings), บันทึกเสียงสั่งการ (voice_chats) และข้อมูลนำส่งชั่วคราว (shipping) ช่วยรักษาโคลนพื้นที่ฟรีได้สูงสุด</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.6) - 28 พ.ค. 2026</h4>
        <ul>
          <li>🔄 <b>ระบบซิงค์อัปเดตข้อมูลลูกค้าในป๊อปอัปแบบเรียลไทม์</b> — ปรับปรุงป๊อปอัปแสดงของจองลูกค้าให้เชื่อมต่อแบบ reactive กับร้านค้า เมื่อใดก็ตามที่มีการจองเพิ่ม การสลับชื่อคน หรือยกเลิกออเดอร์ในหน้าหลักหรือผ่าน Firebase ข้อมูลรายการจอง จำนวนรวม และราคารวมในป๊อปอัปจะเปลี่ยนแปลงและคำนวณใหม่โดยอัตโนมัติทันทีโดยไม่ต้องเปิด-ปิดหน้าต่างใหม่</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.5) - 28 พ.ค. 2026</h4>
        <ul>
          <li>📅 <b>เรียงลำดับรายการจองจากวันที่ล่าสุดไปเก่าสุด</b> — ปรับปรุงการเรียงลำดับของรายการในป๊อปอัปให้แสดงรายการจากไลฟ์รอบล่าสุดขึ้นก่อนเสมอ (วันนี้ -> เมื่อวาน -> วันก่อนๆ) และยังคงจัดกลุ่มของวันเดียวกันไว้ด้วยกัน พร้อมเรียงเลขรายการตามลำดับน้อยไปมาก เพื่อการจัดระเบียบที่ง่ายและเป็นระเบียบที่สุด</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.4) - 28 พ.ค. 2026</h4>
        <ul>
          <li>🎨 <b>แยกสีหมายเลขรายการออกจากวันที่</b> — ปรับปรุงดีไซน์ Badge ในป๊อปอัปให้แยกออกเป็น 2 ป้าย ป้ายแรกแสดงหมายเลขรายการด้วยสีฟ้าไล่ระดับ (Sky to Blue Gradient) เพื่อเน้นข้อมูลหลัก และป้ายที่สองแสดงวันที่จัดส่งด้วยโทนสีเทากระจกโปร่งแสง (Glassmorphism Tag) ทำให้อ่านง่าย สบายตา และมีมิติดีไซน์หรูหรามากยิ่งขึ้น</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.3) - 28 พ.ค. 2026</h4>
        <ul>
          <li>💰 <b>ซ่อนข้อความ "ยังไม่ตั้งราคา" สำหรับรายการที่ไม่มีราคา</b> — หากสินค้ารายการใดยังไม่ได้ตั้งราคา ระบบจะไม่แสดงคำเตือน "ยังไม่ตั้งราคา" ในป๊อปอัปรายการของลูกค้า เพื่อให้หน้าต่างแสดงข้อมูลดูคลีนและกระชับสะอาดตายิ่งขึ้น</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.2) - 28 พ.ค. 2026</h4>
        <ul>
          <li>📅 <b>แสดงวันที่ของรายการจองรอบไลฟ์วันนี้</b> — เพิ่มการแสดงผลวันที่ (เช่น "28 พ.ค. 69") ในวงเล็บของรายการจองรอบปัจจุบัน ให้สอดคล้องกันและสม่ำเสมอเหมือนกันทุกรอบส่งสะสม</li>
          <li>🎨 <b>ปรับโฉมและสีป๊อปอัปให้ชัดเจนขึ้น (Contrast Update)</b> — ปรับแต่งสีตัวเลขนับจำนวนรายการและสีพื้นหลังของป้ายหมายเลขสินค้าในป๊อปอัป จากสีม่วงทึบที่อ่านยาก เป็นสีน้ำเงิน/ฟ้าไล่ระดับ (Sky to Blue Gradient) ทำให้อ่านง่าย ชัดเจน และดูสวยงามมีมิติขึ้นบนพื้นหลังสีเข้ม</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.1) - 28 พ.ค. 2026</h4>
        <ul>
          <li>📅 <b>ย่อชื่อไลฟ์สดใน Badge ให้เหลือแค่วันที่</b> — สำหรับรายการของจองสะสมจากไลฟ์วันก่อนๆ ระบบจะสกัดเอาเฉพาะวันที่ (เช่น "26 พ.ค. 69") มาแสดงแทนชื่อไลฟ์สดที่ยาวเกินไป เพื่อความกระชับและป้องกันการล้นหน้าจอของป๊อปอัป</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.34.0) - 28 พ.ค. 2026</h4>
        <ul>
          <li>👗 <b>แสดงรายละเอียดและลบของจองสะสมได้ทุกวัน (Cumulative Items Modal)</b> — เมื่อกดที่ Badge จอง (👗) ป๊อปอัปจะโหลดรายการจองสะสมของลูกค้าจากทุกรอบไลฟ์ที่ยังส่งไม่เสร็จมาแยกแสดงผล (มีชื่อคลิปย้อนหลังระบุชัดเจน) และสามารถกดลบรายการออกจากรอบส่งและสต็อกของวันก่อนหน้าได้ทันทีเพื่ออำนวยความสะดวกในการจัดของ</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.33.3) - 28 พ.ค. 2026</h4>
        <ul>
          <li>👗 <b>คำนวณยอดจองสะสมรวมทุกวัน (วันนี้ + อดีตค้างส่ง)</b> — ปรับแต่งสูตรการนับยอดจองบน Badge (👗) ในหน้าตารางสินค้าให้คำนวณจาก ยอดจองในรอบไลฟ์วันนี้ รวมกับข้อมูลรอบส่งในอดีตที่ยังจัดส่งไม่เสร็จสิ้น เพื่อความแม่นยำสูงสุดและตอบคำถามลูกค้าได้ทันที</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.33.2) - 28 พ.ค. 2026</h4>
        <ul>
          <li>👗 <b>ปรับปรุงระบบนับยอดจองสะสมข้ามเครื่อง (Badge Sync)</b> — ปรับให้ Badge แสดงจำนวนยอดจองสะสมข้ามวันดึงข้อมูลตรงจาก Database (Firebase) โดยตรง เพื่อแก้ปัญหาตัวเลขนับไม่ตรงกันระหว่างอุปกรณ์ โดยมีระบบ fallback เป็นยอดจองท้องถิ่นหากไม่มีข้อมูลในระบบจัดส่ง</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.33.1) - 28 พ.ค. 2026</h4>
        <ul>
          <li>📦 <b>ระบบแจ้งเตือน "แพ็คคืนนี้" (Pack Tonight)</b> — รายการจัดส่งที่กำหนดส่งพรุ่งนี้จะแสดง Badge "📦 แพ็คคืนนี้" ใต้ countdown พร้อมเน้นแถวด้วยเส้นขอบสีส้มเพื่อเตือนให้เตรียมแพ็คของล่วงหน้า</li>
          <li>📊 <b>เพิ่ม Stat Card "แพ็คคืนนี้"</b> — แสดงจำนวนรายการที่ต้องแพ็คคืนนี้ในแถบสรุปด้านบนของหน้าจัดส่ง พร้อมเอฟเฟกต์เรืองแสงสีส้มอ่อนดึงดูดสายตา (แสดงเฉพาะเมื่อมีรายการ)</li>
          <li>🏷️ <b>แสดง "แพ็คคืนนี้" บนแถบหน้าหลัก</b> — Pill บน Delivery Strip ของรายการที่ส่งพรุ่งนี้จะเปลี่ยนข้อความเป็น "📦 แพ็คคืนนี้" พร้อมสีส้มเรืองแสง เพื่อเตือนให้เห็นได้ชัดขณะทำงานบนหน้าจอหลัก</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.33.0) - 25 พ.ค. 2026</h4>
        <ul>
          <li>🛒 <b>เพิ่มคำจองช่องแชท (ลอง, รหัส, ระหัส, เบอร์)</b> — เพิ่มการรองรับการพิมพ์คำนำหน้ารหัส เช่น "ลอง6", "ระหัส11" หรือ "เบอร์ 4" ให้สามารถทำการจองเข้าคิวระบบได้ตามปกติทันที</li>
          <li>❌ <b>ระบบยกเลิกอัจฉริยะแบบไม่มีหมายเลข (Contextual Cancel)</b> — เมื่อลูกค้าพิมพ์ "ยกเลิก" หรือ "ขอผ่าน" โดยไม่ระบุหมายเลข ระบบจะทำการค้นหาและยกเลิกรายการล่าสุดที่ลูกค้าเคยจองหรือต่อคิวไว้ให้โดยอัตโนมัติ</li>
          <li>🛡️ <b>ป้องกันการยกเลิกผิดพลาด (Strict Standalone Check)</b> — จำกัดการตรวจจับคำว่า "ผ่าน" แบบเดี่ยวๆ เฉพาะคำที่เป็น standalone (เช่น "ผ่านค่ะ", "ขอผ่าน") และจะข้ามการยกเลิกเมื่อพบว่าเป็นข้อความแชทหรือข้อมูลโอนเงิน (เช่น "ผ่านกสิกร") โดยจะเปลี่ยนไปตรวจจับเป็นรอบส่งแทน</li>
          <li>👥 <b>รองรับการถอนตัวออกจากคิวจอง</b> — ปรับปรุงระบบยกเลิกเพื่อให้คิวสำรองสามารถลบชื่อของตัวเองออกจากคิวจองได้โดยตรง หากไม่ใช่เจ้าของตัวจริง โดยที่รายชื่อและลำดับของเจ้าของหรือผู้จองคิวคนอื่นยังคงเดิม</li>
          <li>🔊 <b>แยกเสียง Beep แจ้งเตือนการยกเลิกจริง</b> — สัญญาณเสียง Beep ยกเลิกจะทำงานเฉพาะเมื่อทำรายการยกเลิกสำเร็จ หากค้นหารายการไม่เจอระบบจะสลับมาส่งเสียงอ่านข้อความทั่วไปปกติเพื่อลดความสับสนของแอดมิน</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.32.1) - 25 พ.ค. 2026</h4>
        <ul>
      ...
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.31.4) - 21 พ.ค. 2026</h4>
        <ul>
          <li>🚚 <b>แก้ไขสถานะจัดส่งเสร็จสิ้นคืนค่าเมื่อรีเฟรชหน้าเว็บ</b> — ปรับปรุงโครงสร้างการเก็บข้อมูลจัดส่งของลูกค้าโดยรักษาโครงสร้าง session เดิมไว้และเพิ่มตัวติดตามสถานะจัดส่งราย session (status: "done") แทนการล้าง session เป็นค่าว่าง ทำให้สถานะของลูกค้าคงอยู่ถาวรเมื่อรีเฟรชหน้าเว็บ</li>
          <li>🔄 <b>ระบบตรวจสอบคำสั่งซื้อใหม่ที่แม่นยำ</b> — ปรับปรุง watcher ใน App.vue ให้เช็คจำนวนสินค้าของรอบปัจจุบันเทียบกับรอบก่อนหน้า และจะเปลี่ยนสถานะเป็น "รอดำเนินการ" (Pending) โดยอัตโนมัติก็ต่อเมื่อมีสินค้าจองเข้ามาเพิ่มเท่านั้น</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.31.3) - 21 พ.ค. 2026</h4>
        <ul>
          <li>🔄 <b>ปรับปรุงระบบ State ซิงค์ข้อมูลการจัดส่ง</b> — ย้ายตัวติดตาม (Watcher) ของการซิงค์ข้อมูลลูกค้าจัดส่งจากหน้าต่าง Shipping Manager ไปยัง App.vue (ทำงานเบื้องหลังตลอดเวลา) ทำให้ระบบสามารถคืนสถานะเป็น "รอดำเนินการ" และนับยอดจองรวมได้ทันทีแม้ปิดหน้าต่างอยู่</li>
          <li>⚙️ <b>แก้ปัญหายอดสั่งซื้อเป็น 0 บนหน้าแดชบอร์ด</b> — ปรับปรุงการคำนวณจำนวนชิ้นสะสมของลูกค้าในตาราง Dashboard ให้เป็นการคำนวณแบบ Real-time บนเครื่องฝั่งผู้ใช้ ป้องกันไม่ให้ขึ้นเลข 0 เมื่อเปิด/ปิดหน้าต่าง</li>
          <li>🛡️ <b>ป้องกันปัญหา Race Condition และการบันทึกทับซ้อน</b> — ใช้ระบบ Firebase Transaction (runTransaction) ในการซิงค์ข้อมูลจัดส่งเบื้องหลัง และถอดตัวติดตามชุดเดิมใน ShippingManager.vue ออกเพื่อเสถียรภาพสูงสุด</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.31.2) - 21 พ.ค. 2026</h4>
        <ul>
          <li>🚚 <b>แสดงยอดจองสะสมข้ามวันบนหน้าจอหลัก</b> — คำนวณจำนวนชิ้นของวันก่อนๆ ที่ยังค้างส่งอยู่รวมกับยอดจองของไลฟ์วันนี้ และแสดงผลสะสมบน Badge ในหน้ากระดานหลัก จนกว่าจะส่งของเรียบร้อย (Done)</li>
          <li>📦 <b>ระบบคืนสถานะลูกค้าอัตโนมัติเมื่อสั่งเพิ่ม</b> — เมื่อลูกค้าที่มีสถานะส่งของเสร็จแล้ว (Done) จองสินค้าเพิ่มเข้ามาใหม่ ระบบจะปรับสถานะกลับมาเป็นรอดำเนินการ (Pending) อัตโนมัติและแสดงในตารางคิวจัดส่งทันที</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.31.1) - 21 พ.ค. 2026</h4>
        <ul>
          <li>👗 <b>ปรับปรุงดีไซน์ Badge จองสินค้า (Booking Count)</b> — เปลี่ยนไอคอนเป็นรูปชุดเดรสสีชมพู (👗) และแสดงคำว่า "ตัว" (เช่น 👗 5 ตัว) พร้อมข้อความแนะนำตอนชี้ และปรับพื้นหลังเป็นไล่สีชมพู-ม่วงให้เข้ากับธีมมืดอย่างสวยงาม</li>
          <li>📦 <b>ระบบสะสมยอดจองสะสมรอบจัดส่ง</b> — เพิ่มเสถียรภาพการบันทึกยอดสะสม \`totalBookings\` ใน Firebase ด้วยระบบ Transaction ป้องกันปัญหาเขียนทับข้อมูลชนกัน (Data Race Condition) เมื่อประมวลผลจัดส่ง</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.31.0) - 20 พ.ค. 2026</h4>
        <ul>
          <li>📺 <b>ระบบแสดงชื่อไลฟ์สดถาวร & สถานะจบไลฟ์</b> — แสดงชื่อไลฟ์สดที่เชื่อมต่อล่าสุดไว้ตลอดเวลา (ซิงค์ผ่าน Firebase) แม้จะโหลดหน้าเว็บใหม่ และแสดงสถานะ "🔴 ไลฟ์จบแล้ว" แบบ Real-time ทันทีเมื่อจบไลฟ์บน YouTube</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.30.1) - 18 พ.ค. 2026</h4>
        <ul>
          <li>🛒 <b>ระบบนับจำนวนจอง (Booking Count)</b> — แสดง Badge จำนวนสินค้าที่ลูกค้าจองแบบ Real-time หลังชื่อในตาราง Dashboard (🛒5) อัปเดตทันทีทุกเครื่องเมื่อมีการจองเพิ่มหรือยกเลิก</li>
          <li>📦 <b>ระบบสะสมยอดลูกค้าประจำ (Lifetime Bookings)</b> — เมื่อกด ✅ เสร็จสิ้นในหน้าจัดส่ง ระบบจะสะสมจำนวนสินค้าที่ส่งแล้วไว้ตลอด พร้อมแสดงข้อความ "ลูกค้าประจำ • เคยสั่งรวม X ชิ้น" ใต้ชื่อลูกค้า</li>
          <li>🏷️ <b>แสดงจำนวนจองในตารางสินค้า (×N)</b> — เมื่อลูกค้าจองสินค้า 2 ชิ้นขึ้นไป จะแสดง ×N สีฟ้าหลังชื่อในตาราง StockGrid เช่น "จงกล ×8" เพื่อให้เห็นภาพรวมได้ทันที</li>
        </ul>
      <h4 style="color: #00e676; margin-bottom: 5px;">✨ ก่อนหน้า (4.29.5) - 27 เม.ย. 2026</h4>
        <ul>
